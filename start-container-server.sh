...
/usr/bin/steamcmd +@ShutdownOnFailedCommand 1 +force_install_dir /home/steam/server_dst +@NoPromptForPassword 1 +login anonymous +app_update 343050 validate +quit
